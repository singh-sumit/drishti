...
gh issue create --repo singh-sumit/drishti --title 'Docs: Mermaid compatibility hardening and parser validation' --body-file 'internal-docs/issues/generated/DRISHTI-149.md' --label 'docs' --label 'testing' --label 'v0.4' --milestone 'v0.4 Drishti QEMU CI'
